...
require 'which-key'.register {
  ...
  ['<leader>tr<leader>c'] = { function() F.restart_nvim_qt(F.get_cur_file()) end, 'restart_nvim_qt cur', mode = { 'n', 'v', }, },
  ['<leader>trn'] = { function() F.restart_nvim_qt() end, 'restart_nvim_qt', mode = { 'n', 'v', }, },
  ['<leader>tr<leader>n'] = { function() F.restart_nvim_qt() end, 'restart_nvim_qt', mode = { 'n', 'v', }, },
  ...
  ['<localleader>tb'] = { function() F.toggle_vim_g_winbar() end, 'toggle_vim_g_winbar', mode = { 'n', 'v', }, },
  ['<localleader>t<leader>b'] = { function() F.toggle_winbar() end, 'toggle_winbar', mode = { 'n', 'v', }, },
}
